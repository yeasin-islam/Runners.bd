...
const MarathonCard = ({ marathon }) => {
  ...
  return (
    <div className="fontJakarta card mx-4 lg:mx-0 bg-base-300 shadow-xl transform transition duration-300 hover:scale-105 hover:shadow-xl border border-primary">
      <figure>
        <img
          src={photo}
          alt={title}
