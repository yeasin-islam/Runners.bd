        ...
        <>
            <Swiper navigation={true} modules={[Navigation]} className="poppins mySwiper rounded-lg">
                ...
                <SwiperSlide className="relative h-[80vh] bg-cover bg-center bg-[url('/assets/Image2.jpg')]">
                    ...
                    <div className="relative flex justify-center items-center text-center my-14 mx-8 px-8 rounded-3xl bg-base-300/60 transform transition duration-300 hover:scale-105 hover:shadow-xl">
                        <div className="w-full text-center space-y-6 py-9 ">
                            ...
                            <Link to="/marathons">
                                <button className="btn text-xl font-bold p-4 btn-primary">Get Start</button>
                            </Link>
                        </div>
                    </div>
                </SwiperSlide>
                    ...
                    <div className="relative flex justify-center items-center text-center my-14 mx-8 px-8 rounded-3xl bg-base-300/60 transform transition duration-300 hover:scale-105 hover:shadow-xl">
                        <div className="w-full text-center space-y-6 py-9">
                            ...
                            <Link to="/dashboard/add-marathon">
                                <button className="btn text-xl font-bold p-4 btn-primary">Add Now</button>
                            </Link>
                        </div>
                    </div>
                </SwiperSlide>
                ...
                <SwiperSlide className="relative h-[80vh] bg-cover bg-center bg-[url('/assets/Image6.jpg')]">
                    ...
                    <div className="relative flex justify-center items-center text-center my-14 mx-8 px-8 rounded-3xl bg-base-300/60 transform transition duration-300 hover:scale-105 hover:shadow-xl">
                        <div className="w-full text-center space-y-6 py-9">
                            ...
                            <p className="text-sm sm:text-base md:text-lg max-w-xl mx-auto">
                                Found your perfect run? Apply with just one click. Track your application, get updates, and prepare for race day <br /> stress-free.
                            </p>
                            <Link to="/marathons">
                                <button className="btn text-xl font-bold p-4 btn-primary">Apply Now</button>
                            </Link>
                        </div>
                    </div>
                </SwiperSlide>
                    ...
                    <div className="relative flex justify-center items-center text-center my-14 mx-8 px-8 rounded-3xl bg-base-300/60 transform transition duration-300 hover:scale-105 hover:shadow-xl">
                        <div className="w-full text-center space-y-6 py-9">
                            ...
                            <Link to="/dashboard/my-marathons">
                                <button className="btn text-xl font-bold p-4 btn-primary">Visit Dashboard</button>
                            </Link>
                        </div>
                    </div>
                </SwiperSlide>
